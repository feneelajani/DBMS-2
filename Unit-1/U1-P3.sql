...
BEGIN
	...
	dbms_output.put_line('discount:'||discount_per||'%');
	dbms_output.put_line('discount amount:Rs.'||discount_amt);
	dbms_output.put_line('net amount:Rs'||(total_amt-discount_amt));
END;
/